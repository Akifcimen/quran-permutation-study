...
| **Codex-independent core: Layer 1 ∧ crystal ∧ Two Hands** | **≈ 1.7×10⁻¹⁵ — quadrillion order, measured WITHOUT the independence assumption** via conditional decomposition (`kesif18`): P(crystal) directly counted (17,204 hits) × P(balance∧TwoHands \| crystal) directly sampled (22 hits in 9.0M i.i.d. crystal-conditional samples; independent NumPy/PCG64 stack); 95% CI [1.1–2.6]×10⁻¹⁵. Earlier chained estimates (0.8–1.0×10⁻¹⁵) lie inside the CI | **none** |
