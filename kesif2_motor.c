// Derin permütasyon motoru: iç içe olayların doğrudan ölçümü.
...
int main(int argc, char **argv){
  if(argc >= 2 && strcmp(argv[1], "selftest") == 0){
    ...
    evaluate(AYAT127, &K);
    printf("selftest  A=%llu B=%llu C=%llu D=%llu E=%llu F=%llu G=%llu H=%llu J=%llu\n",
  ...
  printf("T=%llu A=%llu B=%llu C=%llu D=%llu E=%llu F=%llu G=%llu AB=%llu AC=%llu H=%llu J=%llu\n",
