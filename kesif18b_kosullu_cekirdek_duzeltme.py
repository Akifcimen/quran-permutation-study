#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""KESIF-18b: kesif18'in DÜZELTİLMİŞ sürümü (dördüncü dış denetim, 6astraultra, 2 Eylül 2026).
...
print(f"=== P(W|G): ağırlıklı {pW:.3e} | havuz {pooled(hW):.3e}   (GPU çapası 62/17204 = 3.60e-3)")
