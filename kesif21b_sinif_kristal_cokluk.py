#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""KESIF-21b: kesif21'in ÇOKLUK-ORANTILI ÖNERİCİ ile yeniden koşusu (dördüncü denetim sonrası; L/q düzleşir, ESS yükselir).
...
def draw(sig, oris):
    ...
    for content, npar in cells:
        for c in content:
            ...
            wts = np.array([avail[a] for _, a in cand], dtype=float); tot = wts.sum(); i = rng.choice(len(cand), p=wts / tot); n_, a_ = cand[i]
